...
(function(){
  ...
  @media print{
    ...
    /* "PDF ATS" prints with html[data-print="ats"] (cv-export.js also drops the dark theme for it).
       ...
       so this one linearises: main first, then everything the aside held, full width. Plain "PDF"
       keeps the on-screen skin, including the ASCII skill meters — only the ATS pass swaps them
       for a plain word (Expert / Advanced …), since a parser can't read "[████░░]". */
